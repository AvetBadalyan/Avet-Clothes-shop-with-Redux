    ...
    <div className="home">
      ...
      <section className="hero">
        ...
        <div className="hero__content container">
          ...
          >
            Considered essentials and statement pieces, crafted to move with
          ...
          >
            <button className="btn" onClick={() => goShop("women")}>
              Shop Women
            </button>
            <button
      ...
      <section className="section container">
        <header className="section-head">
          ...
          <Link to="/shop" className="section-head__link" onClick={() => goShop()}>
        ...
        <div className="category-grid">
          {CATEGORIES.map((c, i) => (
            <motion.button
              ...
              onClick={() => goShop(c.id)}
            >
              <img src={img(c.image, 800)} alt={c.title} loading="lazy" />
      ...
      <section className="section container">
        <header className="section-head">
          ...
          <button className="section-head__link" onClick={() => goShop()}>
            See all new <Icon name="arrowRight" size={18} />
          </button>
        </header>
